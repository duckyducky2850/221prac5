...
<div class="page-header">
    <h1>Welcome, <?= e($display_name) ?> <img src="<?= BASE_URL ?>/assets/building.PNG" width = "40" height="40" alt="destinations"></h1>
    <p>Manage your packages, group trips and monitor bookings.</p>
</div>

<div class="stats-grid">
    <div class="stat-card">
        <div class="stat-icon"> <img src="<?= BASE_URL ?>/assets/box.PNG" width = "40" height="40" alt="destinations"></div>
        <div class="stat-value"><?= $s['pkg_count'] ?></div>
        <div class="stat-label">Packages</div>
    </div>
    <div class="stat-card">
        <div class="stat-icon"> <img src="<?= BASE_URL ?>/assets/group.PNG" width = "40" height="40" alt="destinations"></div>
        <div class="stat-value"><?= $s['open_trips'] ?></div>
        <div class="stat-label">Open Group Trips</div>
    </div>
    <div class="stat-card">
        <div class="stat-icon"> <img src="<?= BASE_URL ?>/assets/ticket.PNG" width = "40" height="40"></div>
        <div class="stat-value"><?= $s['total_bookings'] ?></div>
        <div class="stat-label">Total Bookings</div>
    </div>
    <div class="stat-card">
        <div class="stat-icon"> <img src="<?= BASE_URL ?>/assets/star.PNG" width = "40" height="40" alt="destinations"></div>
