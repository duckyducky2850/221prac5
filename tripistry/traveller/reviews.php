...
<div>
    ...
    <?php if (empty($my_reviews)): ?>
        <div class="empty-state"><div class="empty-icon">⭐</div><p>You haven't written any reviews yet.</p></div>
    <?php else: ?>
        <?php foreach ($my_reviews as $rev): ?>
        <div class="review-card">
            <div class="review-card-header">
                <div>
                    <?php if ($rev['package_name']): ?>📦 <strong><?= e($rev['package_name']) ?></strong><?php endif; ?>
                    <?php if ($rev['package_name'] && $rev['agency_name']): ?> &nbsp;·&nbsp; <?php endif; ?>
                    <?php if ($rev['agency_name']): ?>🏢 <?= e($rev['agency_name']) ?><?php endif; ?>
                </div>
                <div>
