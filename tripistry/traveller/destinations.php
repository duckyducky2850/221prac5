...
<div class="grid-3">
    ...
    <div class="card">
        php<?php if (!empty($d['image_url'])): ?>
        <div class="card-img-placeholder" style="background-image:url('<?= e($d['image_url']) ?>');background-size:cover;background-position:center;height:130px"></div>
        <?php else: ?>
            <div class="card-img-placeholder"><img src="<?= BASE_URL ?>/assets/HolidayPlaceholder.PNG" height="130"></div>
        <?php endif; ?>
        <div class="card-body">
            ...
            <?php if ($d['popular_season']): ?>
                <p class="text-muted mt-1" style="font-size:.82rem"><img src="<?= BASE_URL ?>/assets/globe.PNG" width = "40" height="40"> Best: <?= e($d['popular_season']) ?></p>
            <?php endif; ?>
        </div>
    </div>
    </a>
...
<div class="tabs mt-2">
    <button class="tab-btn active" data-tab="flights"><img src="<?= BASE_URL ?>/assets/plane.PNG" width = "40" height="40"> Flights (<?= count($flights) ?>)</button>
...
<div class="tab-panel" data-panel="attractions">
    ...
    <div class="grid-3">
        ...
        <div class="card">
            <div class="card-img-placeholder" style="height:120px"><img src="<?= BASE_URL ?>/assets/attractions.PNG" width = "40" height="40"></div>
            <div class="card-body">
                <div class="card-title"><?= e($a['name']) ?></div>
                ...
                <div class="flex-between mt-1">
                    ...
                    <?php if ($a['opening_hours']): ?><span class="text-muted" style="font-size:.8rem"><div class="card-img-placeholder" style="height:120px"><img src="<?= BASE_URL ?>/assets/clock.PNG" width = "40" height="40"></div> <?= e($a['opening_hours']) ?></span><?php endif; ?>
                </div>
            </div>
        </div>
        <?php endforeach; ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="flex-between mt-1">
                    ...
                    <?php if ($r['opening_hours']): ?><span class="text-muted" style="font-size:.8rem"><div class="card-img-placeholder" style="height:120px"><img src="<?= BASE_URL ?>/assets/clock.PNG" width = "40" height="40"></div> <?= e($r['opening_hours']) ?></span><?php endif; ?>
                </div>
