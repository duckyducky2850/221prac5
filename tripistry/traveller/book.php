...
<div style="max-width:600px;margin:0 auto">
    ...
    <div class="form-card" style="max-width:100%;margin-top:1.25rem">
        ...
        <div style="background:var(--clr-bg);border-radius:var(--radius-sm);padding:1rem;margin-bottom:1.5rem">
            ...
            <p class="text-muted" style="font-size:.88rem"><img src="<?= BASE_URL ?>/assets/building.PNG" width = "40" height="40"> <?= e($pkg['company_name']) ?></p>
            <?php if ($gt): ?>
                <p style="font-size:.88rem"><img src="<?= BASE_URL ?>/assets/group.PNG" width = "40" height="40"> Group trip: <?= date('d M Y', strtotime($gt['start_date'])) ?> – <?= date('d M Y', strtotime($gt['end_date'])) ?></p>
            <?php endif; ?>
            <?php if ($pkg['duration_days']): ?><p style="font-size:.88rem"><img src="<?= BASE_URL ?>/assets/clock.PNG" width = "40" height="40"> <?= $pkg['duration_days'] ?> days</p><?php endif; ?>
            <hr class="divider">
        ...
        <form method="POST" action="<?= BASE_URL ?>/traveller/book.php" data-validate>
            ...
            <div class="form-group">
                ...
                <select id="payment_method" name="payment_method" class="form-control" data-required>
                    ...
                    <option value="credit_card"><img src="<?= BASE_URL ?>/assets/card.PNG" width = "40" height="40"> Credit Card</option>
                    <option value="debit_card"><img src="<?= BASE_URL ?>/assets/card.PNG" width = "40" height="40"> Debit Card</option>
                    <option value="paypal">🅿 PayPal</option>
                    <option value="bank_transfer"><img src="<?= BASE_URL ?>/assets/bank.PNG" width = "40" height="40"> Bank Transfer</option>
                </select>
            ...
            <div class="flash flash--info" style="font-size:.85rem">
                <img src="<?= BASE_URL ?>/assets/info.PNG" width = "40" height="40">Payment processing is simulated for demo purposes. No real transaction occurs.
            </div>
